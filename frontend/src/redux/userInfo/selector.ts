...
const getUserTasteCodes = (state: RootState) => state.userInfo.data.tasteCodes;
...
export { getUserInfo, getIsLogin, getUserName, getUserMbti, getIsErrorMSG, getUserTasteCodes };
